...
export default function EditCategoryModal({ visible, onClose, category }: EditCategoryModalProps) {
  ...
  useEffect(() => {
    if (category && visible) {
      ...
      setSelectedScope(category.scopes[0] || 'family');
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {category.isDefault && (
            <View style={styles.warningCard}>
              <Text style={styles.warningTitle}>⚠️ Default Category</Text>
              <Text style={styles.warningText}>
                This is a default category. Changes will only affect the appearance and cannot modify core functionality.
              </Text>
            </View>
          )}
        </ScrollView>
